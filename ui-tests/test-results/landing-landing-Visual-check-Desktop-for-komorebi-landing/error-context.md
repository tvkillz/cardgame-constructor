...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 7608px, received 1280px by 7526px. 428867 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: komorebi-desktop.png

Call log:
  - Expect "toHaveScreenshot(komorebi-desktop.png)" with timeout 80000ms
